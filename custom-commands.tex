...
\newcommand{\Prop}[1][]{\colorbox{defcolor}{\color{titlecolor}{\textbf{Prop.\emptyarg[#1]}}}\kern+0.3ex}
...
\newcommand{\Corollary}[1][]{\colorbox{thmcolor}{\color{titlecolor}{\textbf{Kor.\emptyarg[#1]}}}\kern+0.3ex}
...
%%% Limits
\renewcommand{\liminf}[1]{\lim_{#1\rightarrow +\infty}}
